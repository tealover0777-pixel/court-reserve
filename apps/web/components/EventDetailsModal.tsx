      ...
      <div className={`p-8 ${theme === "DARK" ? "text-white" : "text-stone-900"}`}>
        ...
        <div className="relative h-64 rounded-2xl overflow-hidden mb-8 group">
          ...
          <div className="absolute bottom-6 left-6">
            <span className={`px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase mb-3 inline-block ${theme === "DARK" ? "bg-[#ccff00] text-black" : "bg-white text-black"}`}>
              {event.tag}
            </span>
                ...
                <div className="text-center">
                  ...
                  <button 
                    ...
                    className={`w-full py-4 rounded-xl text-xs font-black tracking-widest uppercase transition-all shadow-lg ${
                      theme === "DARK" ? "bg-[#ccff00] text-black shadow-[#ccff00]/10" : "bg-[#4f6b28] text-white shadow-[#4f6b28]/10"
